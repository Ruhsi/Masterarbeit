...
\DeclareLabelalphaTemplate{
	\labelelement{
		...
		\field{label}
		\field[pcompound=true,namessep={\addhighpenspace und \addhighpenspace }]{labelname}
	}
	\labelelement{
...
\include{./chapters/ServiceorientierteArchitekturenUndMicroservices}
\include{./chapters/ContainerisierungMitDocker}
\include{./chapters/OpenShift}
\include{./chapters/Partnerdatenbank}
\include{./chapters/ImplementierungDerPartnerdatenbank}
\include{./chapters/EvaluierungDerArchitektur}
